...
export const metadata: Metadata = {
  title: 'Betting Glossary – A to Z Football Betting Terms | ScoreNexa',
  description: 'ScoreNexa betting hub: Betting Glossary – A to Z Football Betting Terms. Expert content, updated regularly.',
}
export default function Page() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="flex items-center gap-2 text-xs text-slate-500 mb-4">
        <Link href="/betting" className="hover:text-[#E63946]">Betting</Link><span>›</span><span>Betting Glossary – A to Z Football Betting Terms</span>
      </div>
      <h1 className="text-3xl font-black text-slate-900 mb-2" style={{fontFamily:'Oswald,sans-serif'}}>Betting Glossary – A to Z Football Betting Terms</h1>
