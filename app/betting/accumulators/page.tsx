...
export const metadata: Metadata = {
  title: 'Accumulator Tips – Weekend Football Accas | ScoreNexa',
  description: 'ScoreNexa betting hub: Accumulator Tips – Weekend Football Accas. Expert content, updated regularly.',
}
export default function Page() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="flex items-center gap-2 text-xs text-slate-500 mb-4">
        <Link href="/betting" className="hover:text-[#E63946]">Betting</Link><span>›</span><span>Accumulator Tips – Weekend Football Accas</span>
      </div>
      <h1 className="text-3xl font-black text-slate-900 mb-2" style={{fontFamily:'Oswald,sans-serif'}}>Accumulator Tips – Weekend Football Accas</h1>
