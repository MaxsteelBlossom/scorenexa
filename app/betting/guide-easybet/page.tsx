...
export const metadata: Metadata = {
  title: 'Easybet Review 2025 | ScoreNexa',
  description: 'ScoreNexa betting hub: Easybet Review 2025. Expert content, updated regularly.',
}
export default function Page() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="flex items-center gap-2 text-xs text-slate-500 mb-4">
        <Link href="/betting" className="hover:text-[#E63946]">Betting</Link><span>›</span><span>Easybet Review 2025</span>
      </div>
      <h1 className="text-3xl font-black text-slate-900 mb-2" style={{fontFamily:'Oswald,sans-serif'}}>Easybet Review 2025</h1>
